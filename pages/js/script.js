(function($) {
    ...
    function map() {
        ...
        var myLatLng = new google.maps.LatLng(34.020882,-6.841650);
        var mapProp = {
            center: myLatLng,
            zoom: 11,
            scrollwheel: false,
    ...
    var switcherHtml = '<div class="style-switcher-box"> <div class="switcher-inner"><h5>Style Switcher</h5> <div class="main-list"><div class="list layout"> <span class="list-title">Disposition</span> <div class="sublist"> <ul class="layout-sw"> <li>Large</li> <li class="box">Boîte</li> </ul> </div> </div> </div> <p><span>Note: </span>Vous pouvez choisir entre une disposition large ou une disposition en boite</p> </div> <button class="toggle-btn"><i class="fa fa-cog"></i></button> </div>';
